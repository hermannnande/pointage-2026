...
export const metadata = {
  title: "Suppression des données — PointSync",
  description: "Instructions pour demander la suppression de vos données PointSync.",
};
      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
        <div className="flex gap-4 rounded-xl border bg-card p-6">
          ...
          <div>
            ...
            <p className="mt-2">
              Si vous souhaitez supprimer votre compte PointSync et toutes les données personnelles
        ...
        <div className="space-y-6">
          <div className="rounded-xl border p-6">
            ...
            <ol className="mt-3 list-decimal space-y-2 pl-6">
              <li>Connectez-vous à votre compte PointSync.</li>
          ...
          <div className="rounded-xl border p-6">
            ...
            <p className="mt-3">
              Envoyez un email à{" "}
              <a href="mailto:contact@pointsync.com" className="text-primary hover:underline">
            ...
            <ul className="mt-3 list-disc space-y-1.5 pl-6">
              ...
              <li>L&apos;adresse email de votre compte PointSync</li>
