    ...
    <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          3 jours d&apos;essai gratuit sur tous les plans. Sans carte bancaire.
        </p>
      </div>
          ...
          {[
            {
              ...
              a: "Non. L'essai de 3 jours est totalement gratuit et sans engagement. Aucune carte bancaire n'est requise.",
            },
            {
